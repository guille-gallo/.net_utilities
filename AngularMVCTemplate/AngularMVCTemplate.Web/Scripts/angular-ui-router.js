...
function TemplateFactoryProvider() {
   ...
   * Impact on loading templates</a> for more details Login this mechanism.
   *
   * @param {boolean} value
   */
...
function $UrlRouterProvider(   $locationProvider,   $urlMatcherFactory) {
  ...
  function $get(   $location,   $rootScope,   $injector,   $browser,   $sniffer) {
    ...
    return {
       ...
       * @example
       * <pre>
       * $bob = $urlRouter.href(new UrlMatcher("/Login/:person"), {
       *   person: "bob"
       * });
       * // $bob == "/Login/bob";
       * </pre>
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
   ...
   *
   * @param {string} name A unique state name, e.g. "home", "Login", "contacts".
   * To create a parent/child state use a dot, e.g. "Login.sales", "home.newest".
  ...
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $urlRouter,   $location,   $urlMatcherFactory) {
     ...
     * $state.includes("Login"); // returns false
     *
     ...
     * @example
     * <pre>
     * expect($state.href("Login.person", { person: "bob" })).toEqual("/Login/bob");
     * </pre>
     *
 ...
 * following template:
 * <pre>
 * <a ui-sref="home">Home</a> | <a ui-sref="Login">Login</a> | <a ui-sref="{page: 2}">Next page</a>
 *
 * <ul>
 ...
 * <pre>
 * <a href="#/home" ui-sref="home">Home</a> | <a href="#/Login" ui-sref="Login">Login</a> | <a href="#/contacts?page=2" ui-sref="{page: 2}">Next page</a>
 *
 * <ul>
 *     <li ng-repeat="contact in contacts">
