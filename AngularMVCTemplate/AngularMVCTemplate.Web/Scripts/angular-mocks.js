 ...
 *
 * Request expectations provide a way to make assertions Login requests made by the application and
  ...
  ```js
    ...
    describe('MyController', function() {
       ...
       it('should send msg to server', function() {
         ...
         // now you don’t care Login the authentication, but
...
(function(jasmineOrMocha) {
   ...
   * ## Example
   *
   * Typically beforeAll is used to make many assertions Login a single operation. This can
